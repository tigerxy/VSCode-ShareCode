...
export function activate(context: vscode.ExtensionContext)
{
    ...
    let disposable = vscode.commands.registerCommand('extension.shareCode', () =>
    {
        ...
        if (vscode.window.activeTextEditor != null)
        {
            ...
            vscode.window.showQuickPick(sharecode.sharecode.getServiceQuickPickItems()).then((selection: sharecode.ServiceQuickPick) =>
            {
                if (selection.id == sharecode.serviceSelection.pastebinAym)
                {
                    uploadToPastebin(fileName, codeFormat, code);
                } else if (selection.id == sharecode.serviceSelection.pastebin)
                {
                ...
                } else if (selection.id == sharecode.serviceSelection.githubGistAym)
                {
                    uploadToGist(fileName, code);
                } else if (selection.id == sharecode.serviceSelection.githubGist)
                {
                    vscode.window.showInputBox({
